...
import tiendaInformática.Articulo;
import tiendaInformática.Cliente;
import tiendaInformática.Pedido;
...
public void cargarDatos() {
    clientes.add(new Cliente("11","ANASTASIA CANELITA","655111111"));
    clientes.add(new Cliente("22","LOLA LOLITA","644222222"));
    clientes.add(new Cliente("33","MARC PELAZ","633444444"));
    clientes.add(new Cliente("44","JOAN CANET","677333333"));
    
    articulos.add(new Articulo("1-11","RATON LOGITECH","1-PERIFERICOS", 4,15));
    articulos.add(new Articulo("1-22","TECLADO STANDARD","1-PERIFERICOS", 20,18));
    articulos.add(new Articulo("2-11","HDD SEAGATE 1TB","2-ALMACENAMIENTO", 6,100));
    articulos.add(new Articulo("2-22","SSD KINGSTOM 256GB","2-ALMACENAMIENTO", 9,90));
    articulos.add(new Articulo("2-33","SSD KINGSTOM 512GB","2-ALMACENAMIENTO", 7,150));
    ...
    articulos.add(new Articulo("4-11","MONITOR PHILIPS 24","4-MONITORES", 5,140));
    articulos.add(new Articulo("4-22","MONITOR ASUS 28","4-MONITORES", 3,200));
