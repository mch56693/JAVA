...
//EJERCICIO 4 - PRUEBA EXCEPCION
    ...
    public void cargadatos() {
       clientes.put("11", new Cliente("11","ANA","658111111"));
       clientes.put("22", new Cliente("22","LOLA","649222222"));
       clientes.put("33", new Cliente("33","JUAN","652333333"));
              
       articulos.put("1-11",new Articulo("1-11","RATON LOGITECH","1-PERIFERICOS", 4,15));
       articulos.put("1-22",new Articulo("1-22","TECLADO STANDARD","1-PERIFERICOS", 9,18));
       articulos.put("2-11",new Articulo("2-11","HDD SEAGATE 1TB","2-ALMACENAMIENTO", 6,80));
       articulos.put("2-22",new Articulo("2-22","SSD KINGSTOM 256GB","2-ALMACENAMIENTO", 9,70));
       articulos.put("2-33",new Articulo("2-33","SSD KINGSTOM 512GB","2-ALMACENAMIENTO", 5,120));
       ...
       articulos.put("4-11",new Articulo("4-11","ASUS LED 22     ","4-MONITORES", 5,100));
       articulos.put("4-22",new Articulo("4-22","HP LED 28      ","4-MONITORES", 5,180));
       articulos.put("4-33",new Articulo("4-33","SAMSUNG ODISSEY G5","4-MONITORES", 2,580));
